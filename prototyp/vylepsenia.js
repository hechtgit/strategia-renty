  ...
  function schovajVysvetlenia() {
    ...
    if (set) {
      ...
      if (tipy) {
        ...
        tipy.textContent = 'Na porovnanie, nie ako návrh predpokladu: svetový akciový '
      ...
      vyhrada.textContent = 'Je to váš očakávaný výnos, nie naše odporúčanie.';
    ...
    if (cerpanie) {
      ...
      if (vysvetlenie) vysvetlenie.textContent =
        ...
        + 'silu renty.';
      if (cap) infoPri(cap, [vysvetlenie], 'Prečo sa počas vyplácania počíta opatrnejšie');
    }
  }
